...
--Coppied from Space-age. Going to modify for my shitty reskin.
...
local function railgun_turret_base_direction(inputs)
  return
  {
    layers =
    {
      util.sprite_load("__secretas__/graphics/entity/railgun-turret/railgun-turret-base",
      {
...
local function railgun_turret_extension_direction(inputs)
  return
  {
    layers =
    {
      util.sprite_load("__secretas__/graphics/entity/railgun-turret/railgun-turret-rising-"..inputs.direction,
      {
...
local function railgun_turret_aiming_direction(inputs)
  ...
  return
  {
    layers =
    {
      util.sprite_load("__secretas__/graphics/entity/railgun-turret/railgun-turret-shooting-"..inputs.direction,
      {
